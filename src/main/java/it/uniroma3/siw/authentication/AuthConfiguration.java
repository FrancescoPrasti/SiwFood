...
public class AuthConfiguration {
    ...
    throws Exception{
        ...
        .requestMatchers(HttpMethod.GET,"/","/index","/login","/registrationChef",
                                                    "/chef/{id}","/chefs",
                                                    "/ingredients","/ingredient/{id}","/searchAll",
                                                    "/recipes","/recipe/{id}","/searchRecipes",
                                                    "/css/**", "/images/**").permitAll()
        // chiunque (autenticato o no) può mandare richieste POST al punto di accesso per login e register
        .requestMatchers(HttpMethod.POST,"/","/index","/searchAll","/registration","/login").permitAll()
